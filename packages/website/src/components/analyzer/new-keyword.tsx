  ...
  return (
    <div>
      <div class="form-control w-full max-w-xs">
        ...
        <input type="text" placeholder="Type keyword" class="input input-bordered w-full max-w-xs" value={keyword.value} onInput$={e => {keyword.value = e.target.value}} />
      </div>
      ...
      <div class="form-control w-full max-w-xs">
        ...
        <input type="number" placeholder="Type volume" class="input input-bordered w-full max-w-xs" value={volume.value} onInput$={e => {volume.value = e.target.value}} />
      </div>
